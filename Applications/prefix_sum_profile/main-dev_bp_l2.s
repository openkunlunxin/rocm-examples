...
; %bb.0:
	s_load_dword s3, s[0:1], 0x1c glc
...
; %bb.1:
	...
	global_load_dword v1, v[4:5], off offset:-4 sc1 nt
...
.LBB0_19:
	...
	v_lshl_add_u64 v[4:5], v[2:3], 2, s[4:5]
	s_waitcnt lgkmcnt(0)
	global_store_dword v[4:5], v1, off offset:-4 sc1 nt
	s_or_b64 exec, exec, s[2:3]
	s_and_saveexec_b64 s[2:3], s[0:1]
...
.LBB0_20:
	...
	s_waitcnt lgkmcnt(0)
	global_store_dword v[0:1], v4, off offset:-4 sc1 nt
	s_endpgm
...
; %bb.0:
	s_load_dword s3, s[0:1], 0x1c glc
	s_load_dwordx2 s[4:5], s[0:1], 0x8 glc
	s_waitcnt lgkmcnt(0)
...
; %bb.1:
	...
	s_load_dwordx2 s[0:1], s[0:1], 0x0 glc
	...
	global_load_dword v4, v[2:3], off sc1 nt
