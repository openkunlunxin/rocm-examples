...
; %bb.0:
	s_load_dword s8, s[0:1], 0x24 glc
	s_load_dwordx4 s[4:7], s[0:1], 0x0 glc
	s_load_dword s3, s[0:1], 0x10 glc
	s_waitcnt lgkmcnt(0)
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	global_load_dwordx2 v[6:7], v[6:7], off sc0 nt sc1
	s_add_u32 s8, s8, 8
	s_addc_u32 s9, s9, 0
	s_cmp_eq_u32 s0, s8
	s_waitcnt vmcnt(0)
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	global_load_ubyte v2, v[0:1], off sc0 nt sc1
	s_add_i32 s0, s0, -1
...
.LBB0_9:                                ;   in Loop: Header=BB0_10 Depth=1
	...
	global_store_dword v[2:3], v1, off sc0 nt sc1
	s_cbranch_scc1 .LBB0_20
