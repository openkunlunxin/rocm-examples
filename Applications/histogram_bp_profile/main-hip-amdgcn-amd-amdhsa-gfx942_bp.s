...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	global_load_dwordx2 v[6:7], v[6:7], off sc1 sc0 nt
	s_add_u32 s8, s8, 8
	s_addc_u32 s9, s9, 0
	s_cmp_eq_u32 s0, s8
	s_waitcnt vmcnt(0)
...
.LBB0_4:                                ; %._crit_edge.loopexit.unr-lcssa
	s_and_b32 s0, s3, 7
	s_cmp_eq_u32 s0, 0
	s_cbranch_scc1 .LBB0_7
...
.LBB0_6:                                ; %.epil.preheader
                                        ; =>This Inner Loop Header: Depth=1
	global_load_ubyte v2, v[0:1], off sc1 sc0 nt
	s_add_i32 s0, s0, -1
...
.LBB0_9:                                ; %.loopexit
	...
	global_store_dword v[2:3], v1, off sc1 sc0 nt
	s_cbranch_scc1 .LBB0_20
...
; %bb.14:                               ; %middle.block.unr-lcssa
                                        ;   in Loop: Header=BB0_10 Depth=1
	s_and_b64 vcc, exec, s[4:5]
	s_mov_b32 s11, s17
	s_cbranch_vccnz .LBB0_16
.LBB0_15:                               ; %vector.body.epil
                                        ;   Parent Loop BB0_10 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_add_u32_e32 v1, s10, v5
	ds_read_u16 v1, v1
