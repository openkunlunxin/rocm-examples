...
; %bb.1:
	...
	global_store_dword v0, v1, s[2:3] sc1 nt
.LBB0_2:
	s_endpgm
...
; %bb.1:
	...
	global_load_dword v6, v[8:9], off sc1 nt
	global_load_dword v12, v[10:11], off sc1 nt
	v_lshl_add_u64 v[8:9], s[10:11], 0, v[4:5]
	global_load_dword v10, v[8:9], off sc1 nt
	global_load_dword v7, v[0:1], off sc1 nt
	global_load_dword v13, v[2:3], off sc1 nt
	v_lshl_add_u64 v[2:3], s[4:5], 0, v[4:5]
	s_waitcnt lgkmcnt(0)
	v_lshl_add_u64 v[0:1], s[2:3], 0, v[4:5]
	global_load_dword v0, v[0:1], off sc1 nt
	v_mov_b32_e32 v1, 2.0
	global_load_dword v8, v[2:3], off sc1 nt
	...
	global_store_dword v[2:3], v0, off sc1 nt
.LBB1_2:
	s_endpgm
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
...
; %bb.1:
	...
	global_load_dword v10, v[4:5], off sc1 nt
	global_load_dword v12, v[8:9], off sc1 nt
	...
	global_load_dword v8, v[4:5], off sc1 nt
	global_load_dword v11, v[0:1], off sc1 nt
	global_load_dword v13, v[2:3], off sc1 nt
	v_lshl_add_u64 v[0:1], s[16:17], 0, v[6:7]
	global_load_dword v0, v[0:1], off sc1 nt
	v_lshl_add_u64 v[2:3], s[4:5], 0, v[6:7]
	global_load_dword v9, v[2:3], off sc1 nt
	v_mov_b32_e32 v1, 2.0
...
; %bb.1:
	...
	global_load_dword v8, v[10:11], off sc1 nt
	global_load_dword v14, v[12:13], off sc1 nt
	...
	global_load_dword v5, v[2:3], off sc1 nt
	global_load_dword v9, v[10:11], off sc1 nt
	global_load_dword v15, v[0:1], off sc1 nt
	v_lshl_add_u64 v[2:3], s[4:5], 0, v[6:7]
	s_load_dwordx2 s[4:5], s[0:1], 0x10 glc
	s_waitcnt lgkmcnt(0)
	...
	global_load_dword v0, v[0:1], off sc1 nt
	v_mov_b32_e32 v1, 2.0
	global_load_dword v10, v[2:3], off sc1 nt
...
; %bb.1:
	...
	global_load_dword v15, v[10:11], off sc1 nt
	global_load_dword v3, v[12:13], off sc1 nt
	global_load_dword v5, v[0:1], off sc1 nt
	...
	global_load_dword v2, v[0:1], off sc1 nt
	global_load_dword v4, v[6:7], off sc1 nt
	global_load_dword v12, v[10:11], off sc1 nt
	v_lshl_add_u64 v[0:1], s[4:5], 0, v[8:9]
	global_load_dword v8, v[0:1], off sc1 nt
	s_load_dwordx2 s[4:5], s[0:1], 0x10 glc
	...
	global_store_dword v[0:1], v2, off sc1 nt
.LBB4_2:
	s_endpgm
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
...
; %bb.1:
	...
	global_load_dword v14, v[8:9], off sc1 nt
	...
	global_load_dword v0, v[10:11], off sc1 nt
	global_load_dword v4, v[12:13], off sc1 nt
	...
	global_load_dword v1, v[10:11], off sc1 nt
	global_load_dword v5, v[2:3], off sc1 nt
	global_load_dword v12, v[8:9], off sc1 nt
	v_lshl_add_u64 v[2:3], s[4:5], 0, v[6:7]
	global_load_dword v8, v[2:3], off sc1 nt
